...
namespace ThirdPartyService
{
    class Program
    {
        static async System.Threading.Tasks.Task Main(string[] args)
        {
            ...
            var discovery = await identityClient.GetDiscoveryDocumentAsync("https://localhost:5000");
            ...
            var apiResponse = await apiClient.GetAsync("https://localhost:5001/api/book", HttpCompletionOption.ResponseContentRead);
